...
// Task 2: Add a basic CSS file to the e-commerce website, including product listing grid and a shopping cart section.
// Completed
...
// Task 4: Write a script to dynamically generate the product listing from the product data and display it on the web page. Style the Product card using CSS.
...
// Task 7: Add functionality to update the quantity of products in the cart. Write a fucntion to handle increasing and decresing the quantity of items.
